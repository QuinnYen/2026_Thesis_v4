...
### HKGAN v3.0 vs bert_only 性能比較（5-Seed 平均）

| 數據集 | 模型 | Macro-F1 (%) | Δ F1 | p-value | Cohen's d | 顯著性 |
|--------|------|--------------|------|---------|-----------|--------|
| **Restaurants** | bert_only | 72.68 | - | - | - | - |
| | **HKGAN** | **75.66** | **+2.98** | 0.0158 | 1.80 | Yes * |
| **Laptops** | bert_only | 67.82 | - | - | - | - |
| | **HKGAN** | **71.59** | **+3.77** | 0.0741 | 1.08 | No |
| **REST16** | bert_only | 68.35 | - | - | - | - |
| | **HKGAN** | **77.81** | **+9.46** | 0.0040 | 2.67 | Yes ** |
| **LAP16** | bert_only | 67.14 | - | - | - | - |
| | **HKGAN** | **68.48** | **+1.34** | 0.0057 | 2.42 | Yes ** |
| **MAMS** | bert_only | 83.33 | - | - | - | - |
| | **HKGAN** | **83.96** | **+0.63** | 0.0062 | 2.36 | Yes ** |
...
| 數據集 | bert_only F1 (Mean ± Std) | HKGAN F1 (Mean ± Std) | 穩定性評估 |
|--------|--------------------------|----------------------|------------|
| **Restaurants** | 72.68% ± 0.56% | 75.66% ± 1.18% | Good (CV=1.56%) |
| **Laptops** | 67.82% ± 1.68% | 71.59% ± 1.09% | Good (CV=1.52%) |
| **REST16** | 68.35% ± 1.95% | 77.81% ± 0.74% | Excellent (CV=0.95%) |
| **LAP16** | 67.14% ± 1.46% | 68.48% ± 0.78% | Excellent (CV=1.14%) |
| **MAMS** | 83.33% ± 0.30% | 83.96% ± 0.43% | Excellent (CV=0.51%) |
